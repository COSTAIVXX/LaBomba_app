...
class _BlockGalleryPageState extends State<BlockGalleryPage> {
  ...
  Future<void> _share(String url) async {
    ...
    if (mounted) {
      AppFeedback.showSuccess(context, 'Link da mídia copiado para compartilhar.');
    }
  }
  ...
  Future<void> _download(String url) async {
    ...
    if (uri == null || !await launchUrl(uri, mode: LaunchMode.externalApplication)) {
      if (mounted) {
        AppFeedback.showError(context, 'Não foi possível abrir a mídia em alta resolução.');
      }
    }
  }
      ...
      body: Center(
        child: ConstrainedBox(
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(child: _filter('Data', _dateFilter, ['Todas', 'Hoje', 'Últimos 7 dias'], (value) => setState(() => _dateFilter = value))),
                const SizedBox(width: 12),
                Expanded(child: _filter('Autor', _authorFilter, ['Todos', ...authors], (value) => setState(() => _authorFilter = value))),
              ],
            ),
          ),
          Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(memory.title, maxLines: 1, overflow: TextOverflow.ellipsis),
          ),
          Row(
